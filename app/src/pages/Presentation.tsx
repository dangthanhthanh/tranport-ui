...
const PagePreview: React.FC<PagePreviewProps> = ({ name, image, link }) => (
...
const FolderItem: React.FC<FolderItemProps> = ({ name, icon, tooltip, iconColor }) => {
  ...
  <Button variant="primary" className="m-1">Primary</Button>
    ...
    <section className="section section-sm pt-0" id="pages">
      <Container>
        ...
        <Row className="mb-5">
          {pages.map((page: any) => <PagePreview key={`page-${page.id}`} {...page} />)}
        </Row>
      </Container>
    </section>
    ...
    <section className="section section-lg bg-primary text-white">
      <Container>
        ...
        <Row>
          {features.map((feature: any) => <Feature key={`features-${feature.id}`} {...feature} />)}
        </Row>
      </Container>
    </section>
    ...
    <section className="section section-lg bg-white" id="download">
      <Container>
        ...
        {/* ... Comparison table and technology icons ... */}
        {/* For brevity, you can copy the table and icons from the original code above */}
      </Container>
    </section>
    {/* Footer Section */}
      ...
      <Container>
        <Row>
          ...
          <Col xs={6} md={2} className="mb-5 mb-lg-0">
            ...
            <ul className="links-vertical mt-2">
              <li>
                <Link to={Routes.DocsQuickStart.path} target="_blank">Getting started</Link>
              </li>
              <li><Link to={Routes.DocsChangelog.path} target="_blank">Changelog</Link></li>
              <li><Link target="_blank" to="#">License</Link></li>
            </ul>
          </Col>
