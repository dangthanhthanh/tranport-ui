...
/**
 * Demo page for navigation tabs.
 * Use Tailwind/shadcn/ui for production - this is a demo of react-bootstrap.
 */
const NavsPage: React.FC = () => (
  <article>
    <Container className="px-0">
      ...
      <Documentation
        ...
        description={
          <p>
            The <code>&lt;Nav&gt;</code> component should be used for app navigation, such as for the navigation bar, a secondary menu, or other. The <code>&lt;Nav.Link&gt;</code> component can be attributed with the location of the link.
          </p>
        }
        scope={{ Nav, Row, Col }}
  ...
  <Col lg={6}>
    <Nav fill defaultActiveKey="home" variant="pills" className="flex-column flex-sm-row">
      ...
      <Documentation
        ...
        description={
          <p>
            If you want the nav style to be rounded, just add the <code>rounded</code> class name to the main <code>&lt;Nav.Link&gt;</code> component.
          </p>
        }
        scope={{ Nav, Row, Col }}
        imports={`import { Nav } from '@themesberg/react-bootstrap';`}
  ...
  <Col lg={6}>
    <Nav fill defaultActiveKey="home" variant="pills" className="rounded flex-column flex-md-row">
      ...
      <Documentation
        ...
        description={
          <p>
            If you want to add other content to a navigation item, such as an icon, you can do that by adding a <code>&lt;FontAwesomeIcon&gt;</code> inside the navigation.
          </p>
        }
