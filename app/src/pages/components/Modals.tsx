          ...
          <Col xs={12} className="mb-4">
            <Documentation
              ...
              description={
                <>
                  <p>
                    The <code>&lt;Modal&gt;</code> component can be used as a way to show extra content on top of the existing UI based on an event. For example, you can use the <code>onClick</code> event from a button component to show a modal by using the <code>setShowDefault(true)</code> function.
                  </p>
                  <p>
                    Additionally, you can use the <code>handleClose</code> event to handle the situation when the modal is being closed.
                  </p>
                </>
              }
...
import { Button, Modal } from '@themesberg/react-bootstrap';`}
  ...
  <Modal as={Modal.Dialog} centered show={showDefault} onHide={handleClose}>
    ...
    <Modal.Footer>
      <Button variant="secondary" onClick={handleClose}>I Got It</Button>
      <Button variant="link" className="text-gray ms-auto" onClick={handleClose}>Close</Button>
    </Modal.Footer>
  </Modal>
</React.Fragment>`}
            />
