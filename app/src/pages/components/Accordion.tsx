  ...
  <article>
    <Container className="px-0">
      ...
      <Documentation
        ...
        description={
          <p>
            Use the <code>{`<AccordionComponent>`}</code> component and make sure to set the required props, <code>defaultKey</code> and <code>data</code>, to make it shine. When the title element is toggled you'll get to see the description.
          </p>
        }
